...
import { getEnv, useAppSelector, cn } from '@/utils/index';
...
export default function WebsiteCard(website: Website) {
  ...
  return (
    <div
      ...
      className={cn(
        'flex flex-col gap-y-2 border border-black-50 bg-black-75 rounded-lg p-5 w-full relative group',
        {
          'opacity-50': savingState === 'saving'
        }
      )}
    >
